...
export default class Blank extends React.Component {
  ...
  state = {
    DateTimePicker_4: new Date("10/08/2020"),
    TextInput_5: "",
    TextInput_6: ""
  }
  ...
  render = () => (
    <View style={styles.View_1}>
      <TouchableOpacity
        onPress={() => this.props.navigation.navigate("BlankScreen211921")}
      >
      ...
      <Button
        ...
        onPress={() => this.props.navigation.navigate("BlankScreen111920")}
      />
      <TouchableOpacity
        onPress={() => this.props.navigation.navigate("BlankScreen311922")}
      >
        <DateTimePicker
          showIcon={false}
